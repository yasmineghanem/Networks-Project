...
private:
    ...
    int ackNack;         // the actual ACK/NACK number

public:
    Message(const char *name = nullptr, int kind = 0) : cMessage(name, kind), header(0), payload("N/A"), trailer(0) {}
    Message();
    virtual ~Message();
