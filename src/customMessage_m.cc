...
bool CustomMessage_Base::operator==(const CustomMessage_Base &other)
{
    bool equal = false;
    if (this->header == other.header && this->payload == other.payload && this->trailer == other.trailer && this->frameType == other.frameType && this->ackNack == other.ackNack)
        equal = true;
    return equal;
}
...
int CustomMessage_Base::getTrailer() const
{
    return this->trailer;
}

void CustomMessage_Base::setTrailer(int trailer)
{
...
int CustomMessage_Base::getAckNack() const
{
    return this->ackNack;
}

void CustomMessage_Base::setAckNack(int ackNack)
{
...
int CustomMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 't' && strcmp(fieldName, "trailer") == 0)
        return base + 2;
    if (fieldName[0] == 'f' && strcmp(fieldName, "frameType") == 0)
        return base + 3;
    if (fieldName[0] == 'a' && strcmp(fieldName, "ackNack") == 0)
        return base + 4;
...
int CustomMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc)
    {
    ...
    CustomMessage_Base *pp = (CustomMessage_Base *)object;
    (void)pp;
    switch (field)
    {
    default:
...
const char *CustomMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc)
    {
...
std::string CustomMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc)
    {
    ...
    case 4:
        return long2string(pp->getAckNack());
    default:
        return "";
    }
}

bool CustomMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc)
    {
    ...
    case 3:
        ...
        return true;
    case 4:
        pp->setAckNack(string2long(value));
        return true;
    default:
        return false;
    }
...
void *CustomMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc)
    {
